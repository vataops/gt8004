      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-3 mb-8">
          {mintResults.map((r) => {
            ...
            return (
              <div key={r.networkKey} className="p-4 rounded-lg border border-gray-700 bg-gray-900/50">
        ...
        <div className="space-y-2">
          {mintResults.map((r) => {
            ...
            return (
              <a
                ...
                className="block w-full py-3 rounded-md bg-purple-600 hover:bg-purple-500 text-white text-sm font-medium text-center transition-colors"
              >
          ...
          <a
            href="/"
            className="block w-full py-3 rounded-md border border-gray-700 text-gray-300 text-sm font-medium text-center hover:bg-gray-800 transition-colors"
          >
            Back to Explorer
          </a>
        </div>
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-gray-400">Register your autonomous agent on the ERC-8004 registry</p>
      </div>
            ...
            return (
              <div key={i} className="flex flex-col items-center flex-1">
                <div className="flex items-center w-full">
                  {i > 0 && (
                    <div className={`flex-1 h-0.5 ${isCompleted || isCurrent ? "bg-purple-600" : "bg-gray-700"}`} />
                  )}
                  <button
                    onClick={() => {
                  ...
                  {i < STEPS.length - 1 && (
                    <div className={`flex-1 h-0.5 ${isCompleted ? "bg-purple-600" : "bg-gray-700"}`} />
                  )}
                </div>
      ...
      {/* Step Content */}
      <div className="rounded-lg border border-gray-800 bg-gray-900/30 p-6 mb-4">
        {step === 1 && (
          <StepBasicInfo
            name={state.name}
      ...
      <div className="flex items-center justify-between">
        {step > 1 ? (
          <button
            onClick={handleBack}
            disabled={submitting}
            className="px-4 py-2.5 rounded-md border border-gray-700 text-sm text-gray-300 hover:bg-gray-800 transition-colors disabled:opacity-50"
          >
            &larr; Back
          </button>
        ) : (
        ...
        {step < 7 ? (
          <button
            onClick={handleNext}
            className="px-6 py-2.5 rounded-md bg-purple-600 hover:bg-purple-500 text-white text-sm font-medium transition-colors"
          >
            ...
            {!walletAddress ? (
              ...
              <>
                ...
                <button
                  ...
                  disabled={submitting}
                  className="px-6 py-2.5 rounded-md bg-purple-600 hover:bg-purple-500 text-white text-sm font-medium transition-colors disabled:opacity-50"
                >
                  {submitting
