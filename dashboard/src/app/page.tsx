          ...
          <div>
            ...
            <div className="mt-8 space-y-4">
              {[
                ...
                { text: "Works with any framework", mono: "universal" },
            ...
            <div className="relative rounded-xl border border-[#1a1a1a] bg-[#0a0a0a] overflow-hidden">
              ...
              <div className="flex items-center justify-between px-4 py-3 border-b border-[#1a1a1a]">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px] text-zinc-600 font-mono ml-2">sdk-example.ts</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#00FFE0]/40" />
                  <span className="text-[10px] text-zinc-600 font-mono">TypeScript</span>
                </div>
              </div>
              ...
              <div className="flex">
                <div className="py-5 px-3 text-right border-r border-[#1a1a1a] select-none">
                  {[1, 2, 3, 4, 5, 6, 7].map((n) => (
                    <div key={n} className="text-[11px] leading-relaxed text-zinc-700 font-mono">{n}</div>
                  ))}
                </div>
