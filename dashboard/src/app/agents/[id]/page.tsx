          ...
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold">
              ...
              {agent?.erc8004_token_id != null && (
                <span className="text-zinc-500 ml-1.5 text-base font-normal">
                  #{agent.erc8004_token_id}
                </span>
              )}
            </h2>
          </div>
          <p className="text-xs text-zinc-500 mt-1 font-mono ml-8">{id}</p>
        </div>
      </div>
...
function DeregisterSection({
  ...
  return (
    <div className="bg-[#0f0f0f] border border-red-900/50 rounded-lg p-5">
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
          <div className="bg-[#0f0f0f] border border-[#1f1f1f] rounded-xl p-6 max-w-md w-full mx-4 shadow-2xl">
            ...
            <div className="flex justify-end gap-3">
              <button
                ...
                disabled={loading}
                className="px-4 py-2 rounded-md bg-[#1f1f1f] hover:bg-[#252525] text-gray-300 text-sm transition-colors"
              >
                Cancel
              </button>
              <button
...
function SettingsTab({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
        <h4 className="text-sm font-semibold text-zinc-400 mb-4">Agent Metadata</h4>
          ...
          <div className="space-y-4">
            ...
            {metadataTxHash && agent?.chain_id && (
              <a
                ...
                className="text-sm text-[#00FFE0] hover:text-[#00FFE0]/80 underline inline-block"
              >
            ...
            {/* Info message */}
            <div className="p-3 rounded-lg bg-[#00FFE0]/5 border border-[#00FFE0]/20">
            ...
            <button
              ...
              className="px-4 py-2 rounded-md bg-[#00FFE0] text-black hover:shadow-[0_0_20px_rgba(0,255,224,0.4)] text-sm font-medium transition-colors"
            >
              Done
            </button>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3 py-2 rounded-md bg-[#1f1f1f] hover:bg-[#252525] text-gray-300 text-sm transition-colors"
              >
                Edit Metadata
              </button>
              <button
                ...
                className="px-3 py-2 rounded-md bg-[#141414] hover:bg-[#1f1f1f] text-zinc-400 text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1.5"
              >
          ...
          <div className="space-y-3">
            <textarea
              ...
              className={`w-full h-96 px-3 py-2 bg-gray-950 border rounded-md text-sm font-mono text-gray-300 placeholder-gray-600 focus:outline-none transition-colors ${
                metadataValidationError ? 'border-red-500' : 'border-[#1f1f1f] focus:border-blue-500'
              }`}
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-4 py-2 rounded-md bg-[#00FFE0] text-black hover:shadow-[0_0_20px_rgba(0,255,224,0.4)] text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
              ...
              <button
                ...
                className="px-3 py-2 rounded-md bg-[#1f1f1f] hover:bg-[#252525] text-gray-300 text-sm transition-colors disabled:opacity-50"
              >
                Cancel
              </button>
            </div>
        ...
        {metadataTxStatus !== "idle" && (
          <div className="mt-4 p-4 rounded-lg border border-[#00FFE0]/20 bg-[#00FFE0]/5">
            <div className="flex items-center gap-3">
              <svg className="animate-spin h-5 w-5 text-[#00FFE0]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
              </svg>
              <div className="flex-1">
                <p className="text-sm font-medium text-[#00FFE0]">
                ...
                {metadataTxHash && agent?.chain_id && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-xs text-[#00FFE0] hover:text-[#00FFE0]/80 underline mt-1 inline-block"
                  >
...
function OverviewTab({ agent, networkAgent, id }: OverviewTabProps) {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex gap-5">
          {imageUrl && (
            <img
              src={imageUrl}
              alt={agent?.name || id}
              className="w-20 h-20 rounded-lg object-cover border border-[#1f1f1f] flex-shrink-0"
            />
          )}
          <div className="flex-1 min-w-0">
            ...
            {description && (
              <p className="text-sm text-zinc-400 mt-1 line-clamp-3">{description}</p>
            )}
            <div className="flex flex-wrap items-center gap-3 mt-3 text-xs text-zinc-500">
              {agent?.category && <span className="bg-[#141414] px-2 py-0.5 rounded">{agent.category}</span>}
              {agent?.current_tier && <span className="bg-[#141414] px-2 py-0.5 rounded uppercase">{agent.current_tier}</span>}
              {agent?.protocols?.map((p) => (
                <span key={p} className="bg-[#141414] px-2 py-0.5 rounded">{p}</span>
              ))}
            </div>
          </div>
        </div>
      ...
      {/* On-chain Identity */}
      <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
        <h4 className="text-sm font-semibold text-zinc-400 mb-4">On-chain Identity</h4>
        ...
        <div className="grid grid-cols-2 gap-x-8">
            ...
            <div className="space-y-2">
              ...
              {(agent?.evm_address || networkAgent?.owner_address) && (
                <div className="flex items-center justify-between">
                  ...
                  {explorer ? (
                    <a href={`${explorer}/address/${agent?.evm_address || networkAgent?.owner_address}`} target="_blank" rel="noopener noreferrer" className="text-xs font-mono text-[#00FFE0] hover:text-[#00FFE0]/80">
              ...
              {networkAgent?.creator_address && (
                <div className="flex items-center justify-between">
                  ...
                  {explorer ? (
                    <a href={`${explorer}/address/${networkAgent.creator_address}`} target="_blank" rel="noopener noreferrer" className="text-xs font-mono text-[#00FFE0] hover:text-[#00FFE0]/80">
              ...
              {networkAgent?.created_tx && (
                <div className="flex items-center justify-between">
                  <span className="text-xs text-zinc-500">Created TX</span>
                  {explorer ? (
                    <a href={`${explorer}/tx/${networkAgent.created_tx}`} target="_blank" rel="noopener noreferrer" className="text-xs font-mono text-[#00FFE0] hover:text-[#00FFE0]/80">
              ...
              {network && (
                <div className="flex items-center justify-between">
                  ...
                  {explorer ? (
                    <a href={`${explorer}/address/${network.contractAddress}`} target="_blank" rel="noopener noreferrer" className="text-xs font-mono text-[#00FFE0] hover:text-[#00FFE0]/80">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs text-zinc-500">X-402 Support</span>
                <span className={`text-xs font-medium ${hasX402 ? "text-green-400" : "text-zinc-500"}`}>
                  {hasX402 ? "Supported" : "Not Supported"}
                </span>
              </div>
              {(agent?.agent_uri || networkAgent?.agent_uri) && (
                <div className="flex items-center justify-between">
                  <span className="text-xs text-zinc-500">Agent URI</span>
      ...
      {services.length > 0 && (
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
          <div className="flex items-center justify-between mb-4">
            <h4 className="text-sm font-semibold text-zinc-400">Services</h4>
            <div className="flex items-center gap-3">
              {lastChecked && (
          ...
          <div className="space-y-3">
            {services.map((svc, i) => {
              ...
              return (
                <div key={i} className="p-3 bg-gray-950 rounded-lg border border-[#1a1a1a]">
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-medium text-white">{svc.name}</span>
                      {svc.version && <span className="text-xs text-zinc-500">v{svc.version}</span>}
                      {(svc.name === "A2A" || svc.name === "Origin") && (
                        agent?.sdk_connected_at ? (
                          ...
                          <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[9px] font-medium bg-[#141414]/50 text-zinc-500 border border-[#1f1f1f]/50">
                  ...
                  <p className="text-xs font-mono text-zinc-400 break-all">{svc.endpoint}</p>
      ...
      {meta && (
        <details className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg">
          <summary className="p-5 text-sm font-semibold text-zinc-400 cursor-pointer hover:text-gray-300 transition-colors">
            Raw Metadata
          </summary>
          <div className="px-5 pb-5">
            <pre className="text-xs font-mono text-zinc-400 bg-gray-950 p-4 rounded-lg border border-[#1a1a1a] overflow-x-auto max-h-[400px] overflow-y-auto">
    ...
    <div className="flex flex-col gap-0.5 min-w-0">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <button
          ...
          className="shrink-0 p-0.5 text-zinc-500 hover:text-gray-300 transition-colors"
        >
          {copied ? (
...
function InfoRow({
  ...
  const valClass = `text-sm ${mono ? "font-mono" : ""} ${doTruncate ? "truncate" : "break-all"} ${href ? "text-[#00FFE0] hover:text-[#00FFE0]/80" : "text-gray-300"}`;
  return (
    <div className="flex flex-col gap-0.5 min-w-0">
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-5 gap-4">
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-4">
          ...
          <p className="text-xs text-zinc-500 mt-1">This week: {thisWeekRequests.toLocaleString()}</p>
        </div>
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-4">
          ...
          <p className="text-xs text-zinc-500 mt-1">Last {health?.window_minutes ?? 60}m</p>
        </div>
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-4">
          ...
          <p className="text-xs text-zinc-500 mt-1">{health?.error_count ?? 0} errors</p>
        </div>
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-4">
          <p className="text-xs text-zinc-500 uppercase tracking-wider">x402 Payments</p>
      ...
      {proto && proto.length > 0 && (
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
            <h3 className="text-sm font-medium text-zinc-400 mb-4">Protocol Distribution</h3>
            <div className="space-y-3">
              {proto.map((p) => {
                ...
                return (
                  <div key={key}>
                    <div className="flex items-center justify-between text-xs mb-1">
                      ...
                      <span className="text-zinc-400">{p.request_count.toLocaleString()} ({p.percentage.toFixed(1)}%)</span>
                    </div>
          ...
          <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
            <h3 className="text-sm font-medium text-zinc-400 mb-4">Protocol Performance</h3>
            <table className="w-full text-xs">
              ...
              <tbody>
                {proto.map((p) => (
                  <tr key={protoKey(p.source, p.protocol)} className="border-b border-[#1a1a1a]/50">
        ...
        <ResponsiveContainer width="100%" height={280}>
          {dailyProtoChart ? (
            ...
            <AreaChart data={chartData}>
              ...
              <YAxis tick={{ fontSize: 11, fill: "#71717a" }} axisLine={false} tickLine={false} allowDecimals={false} />
              <Tooltip contentStyle={tooltipStyle} labelStyle={{ color: "#9CA3AF" }} />
              <Area type="monotone" dataKey="requests" stroke="#00FFE0" strokeWidth={2} fill="url(#reqGrad)" />
            </AreaChart>
          )}
        </ResponsiveContainer>
      </div>
      ...
      <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
        <div className="flex items-center justify-between mb-5">
          <h3 className="text-sm font-medium text-zinc-400">Protocol Conversion Funnel</h3>
          {funnel?.summary && (
        ...
        {funnel?.summary ? (() => {
          ...
          const stages = [
            { label: "MCP Customers", count: s.mcp_customers, rate: null as number | null, color: "#00FFE0" },
            ...
            <div className="space-y-4">
              {stages.map((st) => (
                <div key={st.label}>
                  ...
                  <div className="w-full bg-[#141414] rounded-full h-3">
                    <div
      ...
      {funnel?.daily_trend && funnel.daily_trend.length > 0 && (
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
          <h3 className="text-sm font-medium text-zinc-400 mb-4">Conversion Trend (Daily Unique Customers)</h3>
          <ResponsiveContainer width="100%" height={260}>
            <AreaChart data={funnel.daily_trend.map(d => ({ ...d, label: d.date.slice(5).replace("-", "/") }))}>
              ...
              <Tooltip contentStyle={tooltipStyle} labelStyle={{ color: "#9CA3AF" }} />
              <Area type="monotone" dataKey="mcp_customers" name="MCP" stroke="#00FFE0" fill="url(#funnelMcp)" strokeWidth={2} />
      ...
      {funnel?.journeys && funnel.journeys.length > 0 && (
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
          <h3 className="text-sm font-medium text-zinc-400 mb-4">Customer Journeys (MCP → A2A Converts)</h3>
            ...
            <table className="w-full text-xs">
              ...
              <tbody>
                {funnel.journeys.map((j) => (
                  <tr key={j.customer_id} className="border-b border-[#1a1a1a]/50 hover:bg-[#00FFE0]/5">
                    <td className="py-2 pr-4 font-mono text-gray-300">{j.customer_id}</td>
                    <td className="py-2 px-2 text-center">{j.has_mcp ? <span className="text-[#00FFE0]">&#10003;</span> : <span className="text-gray-700">&mdash;</span>}</td>
                    ...
                    <td className="py-2 px-2 text-right font-mono text-zinc-400">{j.days_to_convert != null ? `${j.days_to_convert.toFixed(1)}d` : "—"}</td>
                    <td className="py-2 pl-2 text-right font-mono text-zinc-400">{j.total_requests}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      {/* Row 4: Tool Ranking */}
      <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
        <h3 className="text-sm font-medium text-zinc-400 mb-4">Tool Usage Ranking</h3>
        {tools && tools.length > 0 ? (
          <div className="space-y-1">
            {tools.slice(0, 10).map((t, i) => (
              <div key={t.tool_name} className={`flex items-center gap-3 px-3 py-2 rounded ${i % 2 === 0 ? "bg-[#141414]/30" : ""}`}>
                <span className={`text-xs font-bold w-5 text-right ${i < 3 ? "text-yellow-400" : "text-zinc-500"}`}>
                  {i + 1}
                </span>
                <span className="text-sm text-white flex-1 font-mono truncate">{t.tool_name}</span>
                <span className="text-xs text-zinc-400 font-mono">{t.call_count.toLocaleString()} calls</span>
                <span className="text-xs text-zinc-500 font-mono">{t.avg_response_ms.toFixed(0)}ms</span>
                {t.revenue > 0 && (
      ...
      {mcpTools && mcpTools.length > 0 && (
        <div className="grid grid-cols-2 gap-4">
          {/* MCP Tool Ranking */}
          <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
            <h3 className="text-sm font-medium text-zinc-400 mb-4">MCP Tool Ranking</h3>
            <div className="space-y-1">
              {mcpTools.slice(0, 10).map((t, i) => (
                <div key={t.tool_name} className={`flex items-center gap-3 px-3 py-2 rounded ${i % 2 === 0 ? "bg-[#141414]/30" : ""}`}>
                  <span className={`text-xs font-bold w-5 text-right ${i < 3 ? "text-[#00FFE0]" : "text-zinc-500"}`}>
                    {i + 1}
                  </span>
                  <span className="text-sm text-white flex-1 font-mono truncate">{t.tool_name}</span>
                  <span className="text-xs text-zinc-400 font-mono">{t.call_count.toLocaleString()}</span>
                  <span className="text-xs text-zinc-500 font-mono">{t.avg_response_ms.toFixed(0)}ms</span>
                  {t.error_rate > 0 && (
                    <span className={`text-xs font-mono ${t.error_rate > 0.05 ? "text-red-400" : "text-zinc-500"}`}>
          ...
          {/* MCP Tool Revenue */}
          <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
            <h3 className="text-sm font-medium text-zinc-400 mb-4">MCP Tool Revenue</h3>
            {mcpTools.some((t) => t.revenue > 0) ? (
              <ResponsiveContainer width="100%" height={240}>
                <BarChart data={mcpTools.filter((t) => t.revenue > 0).slice(0, 8)} layout="vertical">
                  ...
                  <Bar dataKey="revenue" fill="#00FFE0" radius={[0, 4, 4, 0]} barSize={20} />
                </BarChart>
              </ResponsiveContainer>
            ) : (
      ...
      {((a2aEndpoints && a2aEndpoints.length > 0) || (cust && cust.top_callers.length > 0)) && (
        <div className="grid grid-cols-2 gap-4">
          ...
          {a2aEndpoints && a2aEndpoints.length > 0 && (
            <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
              <h3 className="text-sm font-medium text-zinc-400 mb-4">A2A Endpoints</h3>
              <table className="w-full text-xs">
                <thead>
                  <tr className="text-zinc-500 border-b border-[#1a1a1a]">
                ...
                <tbody>
                  {a2aEndpoints.map((e) => (
                    <tr key={`${e.method}-${e.endpoint}`} className="border-b border-[#1a1a1a]/50">
                      <td className="py-2 text-[#00FFE0] font-mono">{e.method}</td>
                      ...
                      <td className="py-2 text-right text-zinc-400 font-mono">{e.avg_response_ms.toFixed(0)}ms</td>
          ...
          {cust && cust.top_callers.length > 0 && (
            <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
              <h3 className="text-sm font-medium text-zinc-400 mb-4">Top Callers</h3>
              <table className="w-full text-xs">
                <thead>
                  <tr className="text-zinc-500 border-b border-[#1a1a1a]">
                ...
                <tbody>
                  {cust.top_callers.map((tc) => (
                    <tr key={tc.customer_id} className="border-b border-[#1a1a1a]/50">
      ...
      {health && health.total_requests > 0 && (
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-medium text-zinc-400">Health Monitoring</h3>
            ...
            {[
              ...
              <div key={m.label}>
                <div className="flex items-center justify-between text-xs mb-1">
                  ...
                  <span className="text-zinc-500 font-mono">{(m.rate * 100).toFixed(1)}% ({m.count})</span>
                </div>
                <div className="w-full bg-[#141414] rounded-full h-2">
                  <div
                    className="h-2 rounded-full transition-all"
...
function SpeedInsightsTab({ performance, analytics, dailyStats }: SpeedInsightsTabProps) {
  if (!performance) {
    return (
      <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-8 text-center">
        <p className="text-zinc-500 text-sm">No performance data yet. Start sending requests to see speed insights.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
        <h3 className="text-sm font-medium text-zinc-400 mb-4">Response Time Distribution (24h)</h3>
        <ResponsiveContainer width="100%" height={200}>
          <BarChart data={latencyData} layout="vertical">
            <CartesianGrid strokeDasharray="3 3" stroke="#1a1a1a" horizontal={false} />
            <XAxis type="number" tick={{ fontSize: 11, fill: "#71717a" }} axisLine={false} tickLine={false} tickFormatter={(v) => `${v}ms`} />
            ...
            />
            <Bar dataKey="value" fill="#00FFE0" radius={[0, 4, 4, 0]} barSize={28} />
          </BarChart>
        </ResponsiveContainer>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
          <h3 className="text-sm font-medium text-zinc-400 mb-3">Request Breakdown</h3>
          <div className="space-y-3">
        ...
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
          <h3 className="text-sm font-medium text-zinc-400 mb-3">Detailed Latency</h3>
...
function ObservabilityTab({ recentLogs, chartData, stats }: ObservabilityTabProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Daily errors chart */}
      <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
        <h3 className="text-sm font-medium text-zinc-400 mb-4">Errors Over Time</h3>
        <ResponsiveContainer width="100%" height={200}>
          <AreaChart data={chartData}>
            <defs>
      ...
      <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg overflow-hidden">
        <div className="p-4 border-b border-[#1a1a1a] flex items-center justify-between gap-3">
          <h3 className="text-sm font-medium text-zinc-400">Request Logs</h3>
          <div className="flex items-center gap-3">
            <input
              type="text"
              value={search}
              ...
              className="px-3 py-1.5 bg-gray-950 border border-[#1f1f1f] rounded-md text-xs text-white placeholder-gray-600 focus:outline-none focus:border-gray-500 w-72"
            />
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs">
            <thead>
              <tr className="border-b border-[#1a1a1a] text-zinc-500">
            ...
            <tbody>
              {paged.map((log) => (
                <tr key={log.id} className="border-b border-[#1a1a1a]/50 hover:bg-[#00FFE0]/5">
                  <td className="p-3"><span className="font-mono text-[#00FFE0]">{log.method}</span></td>
                  <td className="p-3 text-gray-300 truncate max-w-[200px]">{log.path}</td>
                  <td className="p-3"><StatusCode code={log.status_code} /></td>
                  <td className="p-3 text-zinc-400 font-mono">{log.response_ms.toFixed(0)}ms</td>
                  <td className="p-3 text-zinc-500 font-mono truncate max-w-[100px]">{log.customer_id || "—"}</td>
                  <td className="p-3 text-zinc-400 font-mono">{log.x402_amount ? `$${log.x402_amount.toFixed(2)}` : "—"}</td>
                  <td className="p-3 text-zinc-500">{timeAgo(log.created_at)}</td>
                </tr>
              ))}
              {paged.length === 0 && (
                <tr>
        ...
        {/* Pagination */}
        {totalPages > 1 && (
          <div className="p-3 border-t border-[#1a1a1a] flex items-center justify-center gap-1">
            <button
              onClick={() => setPage((p) => Math.max(1, p - 1))}
              disabled={safePage <= 1}
              className="px-2 py-1 rounded text-xs text-zinc-400 hover:bg-[#1a1a1a] disabled:opacity-30 disabled:cursor-not-allowed"
            >
              Prev
            </button>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-4">
          <p className="text-xs text-zinc-500 uppercase tracking-wider">Revenue Endpoints</p>
          <p className="text-2xl font-bold mt-1">{byTool.length}</p>
          <p className="text-xs text-zinc-500 mt-1">monetized tools</p>
        </div>
      </div>

      {/* Revenue chart */}
      <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
        <h3 className="text-sm font-medium text-zinc-400 mb-4">Daily Revenue (USDC)</h3>
        <ResponsiveContainer width="100%" height={260}>
          <AreaChart data={chartData}>
            <defs>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
          <h3 className="text-sm font-medium text-zinc-400 mb-3">Revenue by Endpoint</h3>
          {byTool.length > 0 ? (
            <div className="space-y-2">
              {byTool.map((t) => (
        ...
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
          <h3 className="text-sm font-medium text-zinc-400 mb-3">Revenue by Period</h3>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-6 gap-4">
        ...
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-4">
          <p className="text-xs text-zinc-500 mb-1">New This Week</p>
          <p className="text-2xl font-bold text-[#00FFE0]">{newThisWeek}</p>
        </div>
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-4">
          <p className="text-xs text-zinc-500 mb-1">Returning This Week</p>
          <p className="text-2xl font-bold text-purple-400">{returningThisWeek}</p>
        </div>
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-4">
          <p className="text-xs text-zinc-500 mb-1">Active (Low Risk)</p>
        ...
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-4">
          <p className="text-xs text-zinc-500 mb-1">Top Revenue</p>
          <p className="text-lg font-bold text-emerald-400 truncate">
            {topRevenue ? `$${topRevenue.total_revenue.toFixed(2)}` : "-"}
          </p>
          {topRevenue && (
            <p className="text-xs text-zinc-500 font-mono truncate">{topRevenue.customer_id}</p>
          )}
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        <input
          ...
          className="flex-1 bg-[#0f0f0f] border border-[#1f1f1f] rounded-lg px-4 py-2 text-sm text-white placeholder-zinc-500 focus:outline-none focus:border-[#00FFE0]"
        />
        <select
          value={sortBy}
          onChange={(e) => setSortBy(e.target.value as typeof sortBy)}
          className="bg-[#0f0f0f] border border-[#1f1f1f] rounded-lg px-3 py-2 text-sm text-gray-300 focus:outline-none focus:border-[#00FFE0]"
        >
      ...
      <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg overflow-hidden">
        <table className="w-full text-sm">
          <thead>
            <tr className="text-zinc-500 border-b border-[#1a1a1a] text-xs">
              ...
              filtered.map((c) => {
                ...
                return (
                  <tr
                    ...
                    className="border-b border-[#1a1a1a]/50 hover:bg-[#00FFE0]/5 cursor-pointer transition-colors"
                  >
    ...
    <div className="space-y-6">
      ...
      <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-2">
              <span className={`inline-flex items-center gap-1.5 text-xs px-2 py-0.5 rounded-full border ${
                ...
                status.label === "Idle" ? "border-[#00FFE0]/30 text-[#00FFE0] bg-[#00FFE0]/10" :
        ...
        <div className="grid grid-cols-4 gap-4 mt-4 text-xs">
          ...
          <div>
            <p className="text-zinc-500">Active Duration</p>
            <p className="text-gray-300">{activeDays}d</p>
          </div>
          <div>
            <p className="text-zinc-500">Customer Since</p>
            <p className="text-gray-300">{new Date(customer.first_seen_at).toLocaleDateString()}</p>
          </div>
        </div>
      </div>
      ...
      {chartData.length > 0 && (
        <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
          <h3 className="text-sm font-medium text-zinc-400 mb-4">Daily Activity (30d)</h3>
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={chartData}>
              <CartesianGrid strokeDasharray="3 3" stroke="#1a1a1a" />
              ...
              <Tooltip
                contentStyle={{ backgroundColor: "#0f0f0f", border: "1px solid #1a1a1a", borderRadius: "8px" }}
                labelStyle={{ color: "#9CA3AF" }}
              />
              <Area type="monotone" dataKey="requests" stroke="#00FFE0" fill="#00FFE0" fillOpacity={0.1} name="Requests" />
      ...
      {/* Tool/Endpoint Usage */}
      <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
        <h3 className="text-sm font-medium text-zinc-400 mb-4">Tool / Endpoint Usage</h3>
        {tools.length > 0 ? (
          <table className="w-full text-xs">
            <thead>
              <tr className="text-zinc-500 border-b border-[#1a1a1a]">
            ...
            <tbody>
              {tools.map((t) => (
                <tr key={t.tool_name} className="border-b border-[#1a1a1a]/50">
      ...
      {/* Recent Request Logs */}
      <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-lg p-5">
        <h3 className="text-sm font-medium text-zinc-400 mb-4">Recent Requests</h3>
        {logs.length > 0 ? (
          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              <thead>
              ...
              <tbody>
                {logs.map((log) => (
                  <tr key={log.id} className="border-b border-[#1a1a1a]/50">
                    <td className="py-2 text-zinc-400">{timeAgo(log.created_at)}</td>
                    <td className="py-2">
                      <span className="text-[#00FFE0] font-mono">{log.method}</span>
                    </td>
                    ...
                    <td className="py-2 text-center">
                      {log.protocol && (
                        <span className="text-xs px-1.5 py-0.5 bg-[#141414] rounded text-zinc-400">
                          {log.protocol}
                        </span>
                      )}
                    </td>
...
function StatusCode({ code }: { code: number }) {
  const color = code < 300 ? "text-green-400" : code < 400 ? "text-[#00FFE0]" : code < 500 ? "text-yellow-400" : "text-red-400";
