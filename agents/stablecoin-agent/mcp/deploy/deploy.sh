...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --max-instances 3 \
  --timeout 120 \
  --set-env-vars "^;;^AGENT_NAME=${AGENT_NAME:-Stablecoin Search Agent};;AGENT_VERSION=${AGENT_VERSION:-1.0.0};;A2A_BASE_URL=${A2A_BASE_URL:?Set A2A_BASE_URL};;X402_PAY_TO=${X402_PAY_TO:-};;X402_NETWORK=${X402_NETWORK:-base};;X402_PRICE=${X402_PRICE:-0.01};;CDP_API_KEY_ID=${CDP_API_KEY_ID:-};;CDP_API_KEY_SECRET=${CDP_API_KEY_SECRET:-};;INTERNAL_API_KEY=${INTERNAL_API_KEY:-};;GT8004_AGENT_ID=${GT8004_AGENT_ID:-};;GT8004_API_KEY=${GT8004_API_KEY:-};;GT8004_INGEST_URL=${GT8004_INGEST_URL:-https://ingest.gt8004.xyz/v1/ingest}"
