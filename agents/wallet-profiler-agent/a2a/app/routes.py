...
SKILLS = [
    Skill(id="profile", name="Wallet Profile", description="Comprehensive wallet behavior profiling — classification, activity patterns, and behavioral fingerprint", tags=["profile", "wallet", "classify"]),
    Skill(id="portfolio", name="Portfolio Analysis", description="Portfolio composition analysis — asset allocation, diversification, DeFi positions, and cross-chain distribution", tags=["portfolio", "holdings", "assets"]),
    Skill(id="risk", name="Risk Assessment", description="Wallet risk scoring — smart contract risk, approval hygiene, counterparty exposure, and compliance flags", tags=["risk", "security", "safety"]),
    Skill(id="activity", name="Activity Analysis", description="On-chain activity pattern analysis — transaction frequency, DeFi interactions, bridge usage, and governance", tags=["activity", "transactions", "history"]),
]
