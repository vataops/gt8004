...
SERVICE_NAME="${SERVICE_NAME:-ael-calc-agent}"
...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --max-instances 3 \
  --timeout 60 \
  --set-env-vars "^;;^AGENT_NAME=${AGENT_NAME:-Calc Agent};;AGENT_DESCRIPTION=${AGENT_DESCRIPTION:-Math utility agent};;AGENT_VERSION=${AGENT_VERSION:-1.0.0};;GT8004_AGENT_ID=${GT8004_AGENT_ID:-};;GT8004_API_KEY=${GT8004_API_KEY:-};;GT8004_INGEST_URL=${GT8004_INGEST_URL:-https://testnet.ingest.gt8004.xyz/v1/ingest}"
