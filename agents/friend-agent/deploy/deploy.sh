...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --max-instances 3 \
  --timeout 60 \
  --set-env-vars "^;;^LLM_MODEL=${LLM_MODEL:-gpt-4o};;AGENT_NAME=${AGENT_NAME:-Friend-Agent};;AGENT_DESCRIPTION=${AGENT_DESCRIPTION:-General-purpose LLM agent};;AGENT_VERSION=${AGENT_VERSION:-1.0.0};;OPENAI_API_KEY=${OPENAI_API_KEY:?Set OPENAI_API_KEY};;GT8004_AGENT_ID=${GT8004_AGENT_ID:-};;GT8004_API_KEY=${GT8004_API_KEY:-};;GT8004_INGEST_URL=${GT8004_INGEST_URL:-https://api.gt8004.xyz/v1/ingest}"
