"""
ERC-8004 Token Minting Script for Ethereum Mainnet
===================================================
...
Environment (.env):
    ...
    ETH_RPC               - Ethereum mainnet RPC endpoint
...
def build_agent_uri() -> str:
    """Build a data: URI with agent identity metadata."""
    metadata = {
        "type": "https://eips.ethereum.org/EIPS/eip-8004#registration-v1",
        "name": os.environ.get("AGENT_NAME", "GT8004 Support Agent"),
        "description": os.environ.get(
            "AGENT_DESCRIPTION",
            "Official GT8004 platform support agent — helps with SDK integration, registration, troubleshooting, and platform usage",
        ),
...
def main():
    ...
    print(f"Chain:    Ethereum Mainnet ({CHAIN_ID})")
    print(f"Registry: {registry_addr}")
    print(f"Name:     {os.environ.get('AGENT_NAME', 'GT8004 Support Agent')}")
    ...
    print(f"  https://gt8004.xyz/explorer")
